 ...
 */
public class PeralatanSensor implements Serializable {

    private String idPeralatanSensor;
    ...
    public String getIdPeralatanSensor() {
        return idPeralatanSensor;
    }

    public void setIdPeralatanSensor(String idPeralatanSensor) {
        this.idPeralatanSensor = idPeralatanSensor;
    }
