 ...
 */
@Service("secUserLoginService")
@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
public class SecUserLoginService extends DatabaseSupport<SecUserLogin> implements ISecUserLoginService {

    @Autowired
    private ISecUserDao userDao;

    public SecUserLoginService() {
