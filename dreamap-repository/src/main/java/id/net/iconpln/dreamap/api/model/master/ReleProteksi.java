 ...
 */
public class ReleProteksi implements Serializable {
    ...
    private String jenisRelay;

    public String getIdRelay() {
        return idRelay;
    }
    ...
    public String getJenisRelay() {
        return jenisRelay;
    }

    public void setJenisRelay(String jenisRelay) {
        this.jenisRelay = jenisRelay;
    }
}
