 ...
 */
public class PeralatanBantu implements Serializable {

    private String idPBantu;
    ...
    public String getIdPBantu() {
        return idPBantu;
    }

    public void setIdPBantu(String idPBantu) {
        this.idPBantu = idPBantu;
    }
