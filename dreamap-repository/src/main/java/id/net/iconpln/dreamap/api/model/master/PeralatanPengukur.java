 ...
 */
public class PeralatanPengukur implements Serializable {

    private String idPngkurInstr;
    ...
    private String fumgsi;

    public String getIdPngkurInstr() {
        return idPngkurInstr;
    }

    public void setIdPngkurInstr(String idPngkurInstr) {
        this.idPngkurInstr = idPngkurInstr;
    }
    ...
    public String getFumgsi() {
        return fumgsi;
    }

    public void setFumgsi(String fumgsi) {
        this.fumgsi = fumgsi;
    }
}
