 ...
 */
public class AlatBantuApp implements Serializable {

    private String idAlatBantu;
    ...
    private float kelasKetelitian;
    private String rasioInOut;

    public String getIdAlatBantu() {
        return idAlatBantu;
    }

    public void setIdAlatBantu(String idAlatBantu) {
        this.idAlatBantu = idAlatBantu;
    }
    ...
    public float getKelasKetelitian() {
        return kelasKetelitian;
    }

    public void setKelasKetelitian(float kelasKetelitian) {
        this.kelasKetelitian = kelasKetelitian;
    }

    public String getRasioInOut() {
        return rasioInOut;
    }

    public void setRasioInOut(String rasioInOut) {
        this.rasioInOut = rasioInOut;
    }
}
